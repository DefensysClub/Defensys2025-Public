...
with open("flag not encrypted.txt", "r", encoding="utf-8") as file:
...
with open("flag encrypted.txt", "w", encoding="utf-8") as file:
    # Write encrypted flag by key
    file.write(hexxor(key,flag.encode('utf-8').hex()))